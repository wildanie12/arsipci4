...
<div class="container-fluid text-center text-md-left justify-content-center">
    ...
    <button type="button" class="btn btn-success btn-add mb-3 align-self-center">Tambah Data</button>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modal-title-default">
                        <span class="fill-judul_modal">Tambah Data Asesi</span>
                    </h4>
                ...
                <div class="modal-body">
                    <div class="form-group row mb-3">
                        <div class="col-lg-8">
                            ...
                            <div class="text-muted font-italic text-s pt-2">Gunakan ukuran foto dengan rasio 3x4</div>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-alternative">
                            <input class="form-control" type="text" name="tempat_lahir" maxlength="100">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Tanggal Lahir</label>
                        <div class="input-group input-group-alternative">
                            <input type="date" name="tanggal_lahir" class="form-control datepicker" id="tanggal_lahir">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>NIK</label>
                        <div class="input-group input-group-alternative">
                            <input class="form-control" type="text" name="nik" maxlength="100">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Pekerjaan</label>
                        <div class="input-group input-group-alternative">
                            <input class="form-control" type="text" name="pekerjaan" maxlength="100">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Pendidikan Terakhir</label>
                        <div class="input-group input-group-alternative">
                            <input class="form-control" type="text" name="pendidikan_terakhir" maxlength="100">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="text-muted font-italic text-s pt-2">Nomor Sertifikat Harus Unik</div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-8">
                            <div class="input-group input-group-alternative">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input input-gambar-b" name="muk" accept="application/pdf">
                                    <label class="custom-file-label" for="customFileLang">Pilih Gambar</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group focused preview_upload_muk">
                            <embed src="file_name.pdf" class="fill-gambar-b" width="300px" height="300px"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-8">
                            <div class="input-group input-group-alternative">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input input-gambar-c" name="portofolio" accept="application/pdf">
                                    <label class="custom-file-label" for="customFileLang">Pilih Gambar</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group focused preview_upload_portofolio">
                            <embed src="file_name.pdf" class="fill-gambar-c" width="300px" height="300px"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-8">
                            <div class="input-group input-group-alternative">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input input-gambar-d" name="sertifikat_kompetensi" accept="application/pdf">
                                    <label class="custom-file-label" for="customFileLang">Pilih Gambar</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group focused preview_upload_sertifikat_kompetensi">
                            <embed src="file_name.pdf" class="fill-gambar-d" width="300px" height="300px"/>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="modal-detail">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title mb-3">Detail Data Asesi</h4>
                <button class="close" data-dismiss="modal" type="button">&times;</button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-8">
                        <div class="row border-1 mb-3">
                            <div class="col">
                                <h4><span class="font-weight-bold fill-nama">Nama namamnama</span></h4>
                            </div>
                        </div>
                ...
                <div class="row border-1 border-bottom mb-3">
                    <div class="col">   
                        ...
                        <embed src="file_name.pdf" class="fill-muk" width="800px" height="2100px" />
                    </div>
                </div>
                ...
                <div class="row border-1 border-bottom mb-3">
                    <div class="col">   
                        ...
                        <embed src="file_name.pdf" class="fill-portofolio" width="800px" height="2100px" />
                    </div>
                </div>
                ...
                <div class="row border-1 border-bottom mb-3">
                    <div class="col">   
                        ...
                        <embed src="file_name.pdf" class="fill-sertifikat_kompetensi" width="800px" height="2100px" />
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $("#form").submit(function (e) {
        ...
        url = operationMode == 'tambah' ? "<?=site_url('asesi/ajax_create')?>" : "<?=site_url('asesi/ajax_modify/')?>" + id;
    ...
    $('body').on('click', '.btn-detail', function(e) {
        ...
        $.ajax({
            type: "get",
            url: "<?=site_url('asesi/ajax_single')?>",
            data: {id: id},
            dataType: "json",
    ...
    $('body').on('click', '.btn-delete', function() {
        if (confirm('apakah anda yakin?')) {
            ...
            $.ajax({
                type: "POST",
                url: "<?=site_url('asesi/ajax_delete')?>",
                data: {id: id},
                dataType: "json",
                success: function (response) {
                    $("#table-1").DataTable().ajax.reload()
