...
class Surveilance extends BaseController
{
    public function index()
    {
        $data = [
            'ui_title' => 'Data Surveilance'
        ];
        return view('user/surveilance', $data);
    }
    ...
    public function ajax_list()
    {
        ...
        $data_asesi = $asesiModel->where('tanggal_expired_sertifikat <=', date('Y-m-d'))->findAll();
        ...
        foreach ($data_asesi as $index =>  $asesi) {
            ...
            // $expired = strtotime($asesi->tanggal_expired_sertifikat);
            // $currenttime = strtotime(date("Y/m/d"));

            // // print_r($expired - $currenttime);
            // // print_r($expired);
            // // die;

            // if ($currenttime  $expired){
            
            // $data[$index]['tanggal_expired_sertifikat'] = $expired; 
